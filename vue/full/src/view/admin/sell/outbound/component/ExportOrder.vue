    ...
    <div id="order-form" class="order-form">
      ...
      <div class="signatures">
        <div class="signature-column">
          <div class="stamp"></div>
          <div class="company-name">{{ companyName1 }}（签章）</div>
          <div class="time">{{ signDate1 }}</div>
        </div>

        <div class="signature-column">
          <div class="stamp">
            <img class="stamp-img" src="/static/img/stamp.jpg" alt="公司印章" />
          </div>
          <div class="company-name">{{ companyName2 }}（签章）</div>
          <div class="time">{{ signDate2 }}</div>
        </div>
      </div>
    </div>
